...
export function Card(props: CardProps) {
    ...
    if (!data) {
        return <CardContainer><Spinner /></CardContainer>
    }
    ...
    return <CardContainer>
        ...
        <RentControlsGroup>
            ...
            <Input value={currentRentPrice} type="number" min={currentPrice} step="0.01" onChange={handleOnChange} />
            <Button active onClick={handleCardRent}>Rent</Button>
        </RentControlsGroup>
    </CardContainer>
}